...
#pragma config(Motor,  port2,           driveFrontRight, tmotorVex393HighSpeed_MC29, openLoop, driveLeft, encoderPort, I2C_4)
#pragma config(Motor,  port3,           liftMobileLowerRight, tmotorVex393HighSpeed_MC29, openLoop, reversed, driveLeft)
...
#pragma config(Motor,  port8,           liftMobileLowerLeft, tmotorVex393HighSpeed_MC29, openLoop, driveRight)
#pragma config(Motor,  port9,           driveFrontLeft, tmotorVex393HighSpeed_MC29, openLoop, driveRight, encoderPort, I2C_3)
